...
async function updateSession(request) {
    ...
    const supabaseUrl = ("TURBOPACK compile-time value", "https://szvlbkowmhpubjjkijnp.supabase.co");
    const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN6dmxia293bWhwdWJqamtpam5wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjcxNTI5NTYsImV4cCI6MjA4MjcyODk1Nn0.mTVCJRZW_BS1KxrJzeFuS2bo6YCK2zGXousCjw9sztc");
...
async function proxy(request) {
    ...
    const { user, supabaseResponse } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$middleware$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["updateSession"])(request);
