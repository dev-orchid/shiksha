...
/**
 * POST /api/super-admin/settings/razorpay/test
 * Test platform Razorpay connection with provided credentials
 */
export async function POST(request: NextRequest) {
  try {
    ...
    // Only super_admin can test platform payment settings
